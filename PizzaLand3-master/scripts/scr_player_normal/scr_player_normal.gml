function scr_player_normal()
{
	...
	if (machslideAnim == 0 && landAnim == 0 && shotgunAnim == 0)
	{
	    if (move == 0)
	    {
	        ...
	        if (idle >= 300 && sprite_index != spr_player_idle && sprite_index != spr_player_idle && sprite_index != spr_player_idle)
	        {
	            randomise()
	...
	if (grounded && input_buffer_jump < 8 && (!key_down) && (!key_slap) && vsp > 0)
	{
	    scr_sound(sound_jump)
	    sprite_index = spr_jump
	    if (shotgunAnim == 1)
