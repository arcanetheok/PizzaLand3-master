// Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed Script assets have changed 
...
/// @description Checks if the provided variable isnt any of the transformation states
/// @param state
